...
rois = {'rSMA_bilat' 'rthal_bilat'}; %'rHC_right'
subjects = {
    {'18y404','18y566','20y297','20y396','20y415','20y439','20y441','20y444','20y455','21y299','21y437','21y521','21y534','22y422','23y452','23y546','25y543'}
    {'67o136','67o153','67o178','69o144','69o277','70o118','70o316','71o152','71o193','72o164','73o165','75o320','76o120','76o162','79o108','79o117','79o279','80o121','80o128','81o125','81o312','83o197'}
}; 
study_path = 'S:\nad12\FAME8\Analysis_ret\FAME_categorymodel_ret_hrf';

for rr = 1:length(rois)
    roi_label = rois{rr};
    filename = ['Compiled_rho_', roi_label, '.xlsx'];
    ...
    for sg = 1:length(subjects) %subject group
        for ss = 1:length(subjects{sg}) %subject num in group
            ...
            data_path = fullfile(study_path, subjects{sg}{ss}, 'RSA_Results_oddeven', ['RSAtest_' subjects{sg}{ss} '_' roi_label '_rho_.xlsx']);
            ...
            corr3 = xlsread(data_path, 'Sheet1', 'C2');
            xlswrite(fullfile(study_path, filename), corr3, sheet, strcat('C', rownum));
            
            corr4 = xlsread(data_path, 'Sheet1', 'E4');
            xlswrite(fullfile(study_path, filename), corr3, sheet, strcat('D', rownum));
            
            corr5 = xlsread(data_path, 'Sheet1', 'F4');
            xlswrite(fullfile(study_path, filename), corr3, sheet, strcat('E', rownum));
            
            corr6 = xlsread(data_path, 'Sheet1', 'F5');
            xlswrite(fullfile(study_path, filename), corr3, sheet, strcat('F', rownum));
